<template>
  <div>
    <div class="navigationFill" :style="{'height': (paddingTopH+40)+'px'}"></div>
    ...
    <div class="navigationStyle" :class="{'record-style':currentPage==='record-index'}" :style="{'padding-top': paddingTopH+'px','height':'32px','padding-bottom': '8px'}">
      <div class="navigation_left">
          <img  src="https://img.sudichina.com/public/app_goods_imgs/bar_goback.png" class="bar_goback" @click="goback" v-if="showGoback || gobackUrl" />
          <img src="https://img.sudichina.com/public/app_goods_imgs/bar_gohome.png" class="bar_gohome" @click="gohome" v-else-if="showGohome && !noHome" />
      </div>
